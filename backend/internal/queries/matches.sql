...
INSERT INTO matches (employee_id, match_score, matching_skills, notes)
VALUES ($1, $2, $3, $4)
RETURNING id, created_at;

-- Delete matches by employee ID
-- Query name: delete_matches_by_employee_id
DELETE FROM matches WHERE employee_id = $1;
